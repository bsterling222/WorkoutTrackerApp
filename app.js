...
// Helper to get local date string YYYY-MM-DD (prevents UTC timezone rollover bugs)
...
let activeSelectedDate = getLocalDateString(); // 👈 Uses local timezone instead of ISO/UTC
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const today = getLocalDateString(); // 👈 Uses local timezone
